            ...
            <div className="container mx-auto px-10 md:px-18 xl:px-19 2xl:px-19">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-[40px] font-normal text-black w-full leading-tight max-w-328">
                        ...
                        <span className="text-primary font-bold text-3xl xl:text-[40px]">Our solutions are built to deliver efficiency, safety, and long-term resilience for industries.</span>
                    </h2>
                </motion.div>
